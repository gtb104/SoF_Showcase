<script>
	import { appState, boosters } from '$lib/stores/index.js';
	import { adjudicators } from '$lib/stores/adjudicators.js';
	import { seniors } from '$lib/stores/seniors.js';
	...
	const formattedDate = dateFormatter.format(appState.eventDate);
</script>
...
<svelte:head>
	...
	<meta
		name="description"
		content="Official program guide for the Freedom Marching Band Showcase competition"
	/>
</svelte:head>
...
<section class="card info-section">
	...
	<p>
		Welcome to the <a href="https://www.vmbc-online.org/">Virginia Marching Band Cooperative</a> Freedom
		Showcase, an annual marching band competition hosted by the Freedom High School Marching Band. This
		event features performances from high school marching bands across the region competing for awards
...
<section class="card visitor-info-section">
	...
	<div class="visitor-info-columns">
		<div class="admission-column">
			...
			<p class="price-note">* All proceeds support the Freedom Marching Band</p>
		</div>
...
<section class="card airgrams-section">
	<h2>AirGrams</h2>
	<p class="airgram-description">
		Send an over-the-loudspeaker shout out to your favorite marcher, director, or friend!
	</p>
...
<section class="card adjudicators-section">
	...
	<a
		href="https://0f15d2ba-85cb-4910-bef6-3cc6d22b8036.filesusr.com/ugd/ff63ab_0b6a1286897e4d4d8e81a02459d37213.pdf"
		>How are groups judged?</a
	>
</section>
...
<section class="card seniors-section">
	...
	<p class="senior-intro">
		We celebrate and honor the graduating seniors of the Spirit of Freedom Marching Band:
	</p>
...
<section class="card boosters-section">
	...
	{#if appState.specialThanks}
		<div class="special-thanks">
			<h3>Special Thanks</h3>
			<p>{appState.specialThanks}</p>
		</div>
	{/if}
</section>
